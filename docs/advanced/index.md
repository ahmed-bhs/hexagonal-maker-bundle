...
- [WHY-HEXAGONAL](../WHY-HEXAGONAL.md) - Business case and benefits
- [ARCHITECTURE](../ARCHITECTURE.md) - Complete architecture guide (French)
- [SOLID Principles](../SOLID.md) - SOLID in hexagonal architecture (French)
